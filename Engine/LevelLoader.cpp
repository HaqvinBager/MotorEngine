...
{	
	...
	playerGameObject->myTransform->Position({ 0.0f, 0.0f,0.0f});
	playerGameObject->myTransform->Rotation({ 0.0f, 0.0f,0.0f });
	playerGameObject->AddComponent<CModelComponent>(*playerGameObject, "Assets/Graphics/Skeletons/CH_PL_Frog_SK.fbx");
