...
CAnimatedUIElement::CAnimatedUIElement(std::string aFilePath, CScene& aScene) : mySpriteInstance(nullptr), myLevel(1.0f)
{
    ...
    mySpriteInstance = new CSpriteInstance(aScene);
