...
{
public:
	CEnviromentLightComponent(CGameObject& aParent, DirectX::SimpleMath::Vector4 aColorAndIntensity = { 1.f, 1.f, 1.f, 1.f }, DirectX::SimpleMath::Vector3 aDirection = {0.f, 0.f, 1.f});
